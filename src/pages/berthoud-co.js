  ...
  async render() {
    return `
      ...
      <div class="left-container">
        <img src="src/images/officebuilding.jpg" alt="Berthoud, CO Office" class="location-co-image"/>
        <div class="opening-hours">
          <h2>Opening Hours</h2>
          <ul>
            <li class="open-day">Monday: 10am - 7pm</li>
            <li class="closed-day">Tuesday: closed</li>
            <li class="open-day">Wednesday: 10am - 7pm</li>
            <li class="closed-day">Thursday: closed</li>
            <li class="open-day">Friday: 10am - 7pm</li>
        ...
        <div class="contact-info">
          ...
          <p class="location-co-address"> <i class="fa-regular fa-address-book"></i> Shari McCallum,<br> The Rolfing Works & The Holistic Face,<br> Berthoud, CO 80513</p>
